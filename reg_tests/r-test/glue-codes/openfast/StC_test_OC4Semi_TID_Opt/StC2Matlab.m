function DataOut = StC2Matlab(StC_file,hdrLines,DataOut)
%% StC2Matlab
% Function for reading StC input files in to a MATLAB struct.
%
%
...
%
% In:   StC_file    -   Name of StC input file
...
%----------------------Read FST main file----------------------------------
fid = fopen(StC_file,'r');

if fid == -1
    error(['StC file, ' StC_file ', could not be opened for reading. Check if the file exists or is locked.'])
end
