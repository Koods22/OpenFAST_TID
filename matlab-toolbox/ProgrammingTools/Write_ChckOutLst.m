...
ModuleName = 'ServoDyn'; % e.g. ElastoDyn, ServoDyn, AeroDyn, FAST_Farm

OFDir    = 'C:\Users\kdoku\Documents\openFAST_TMD\OpenFAST_TID\'; % Directory containing OpenFAST repository (to find Excel file, and output FORTRAN files)
addErrChk = false;
