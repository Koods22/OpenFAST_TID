...
MODULE StrucCtrl
  ...
  ! PUBLIC :: StC_CalcConstrStateResidual        ! Tight coupling routine for returning the constraint state residual
   ...
   INTEGER(IntKi), PRIVATE, PARAMETER :: DOFMode_TID           = 5          !< tuned inerter damper w/ damping force equation
...
!..................................................................................................................................
      ...
      ELSE
         ...
         IF ((p%StC_DOF_MODE == DOFMode_Indept .OR. p%StC_DOF_MODE == DOFMode_TID) .AND. .NOT. p%StC_Z_DOF) THEN
            do i_pt=1,p%NumMeshPts
