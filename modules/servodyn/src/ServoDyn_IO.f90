...
! ===================================================================================================
   ...
   INTEGER(IntKi), PARAMETER      :: SStC_bQ(MaxStC)    = (/ SStC1_bQ,  SStC2_bQ,  SStC3_bQ,  SStC4_bQ  /)
   INTEGER(IntKi), PARAMETER      :: SStC_bQD(MaxStC)   = (/ SStC1_bQD, SStC2_bQD, SStC3_bQD, SStC4_bQD /)
...
subroutine Set_SStC_Outs_Instance( i, x, m, y, AllOuts )     ! Platform 
   ...
   if (i < MaxStC) then
      ...
      AllOuts(SStC_bQ( i)) = x%StC_x(7,1)                ! b
      AllOuts(SStC_bQD(i)) = x%StC_x(8,1)                ! b-dot
